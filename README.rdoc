...
An .Net wrapper for Harvest API.
...
This version currently covers all "Project" service requests and a few "client" service requests, other requests maybe added in the future but you can extend IHarvestService.cs and IHarvestService.cs to handle more of the API.

[Simon Jackson][http://www.simonjackson.info] - [Prosperity 24.7][http://www.prosperity247.com/]

http://i53.tinypic.com/2nknqls.png
